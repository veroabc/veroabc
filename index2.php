...
// upate data if update button is clicked
        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-responsive">
                ...
                <tbody>
									<div  class="container">
										<br />
										<h2 align="center">Schnell Suche!</h2><br />
										<div class="form-group">
											<div class="col-md-8 col-lgoffset-2 input-group">

												<input type="text" name="search_text" id="search_text" placeholder="Suche!" class="form-control" autocomplete="on" />
											</div>
										</div>
										<br />
									<div id="result"></div>
