...
<head>
    ...
    <title>key_logger Application</title>
    <!-- Bootstrap Core CSS -->
            ...
            <form class="form-horizontal" action="index.php" method="POST" >
                <div class="form-group">
                    <div class="col-md-4 col-md-offset-2">
                        <input type="text" name="plattform" class="form-control " placeholder="plattform" value="<?php if (isset($first_name)) echo $first_name;?>">
                    </div>

                    <div class="col-md-4">
                        <input type="text" name="loginpw" class="form-control" placeholder="loginpw" value="<?php if (isset($last_name)) echo $last_name;?>">
                    </div>
                </div>
